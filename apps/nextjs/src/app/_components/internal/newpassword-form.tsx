...
export function InternalNewPasswordForm({ id }: { id: string }) {
    ...
    const newpass = api.web.auth.newPassword.useMutation({
        onSuccess: async (res) => {
            console.log(res, "success")
            router.push("/login")
            toast("Contraseña restablecida con exito", {
    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        newpass.mutate({ challengeId: id, password: data.password })
    }
