            ...
            {options?.nav &&
                <div className="flex items-center w-full py-2">
                    <NavigationMenu>
                        <NavigationMenuList>
                            <NavigationMenuItem>
                                <Link href={`/internal/v1`} legacyBehavior passHref>
                            ...
                            <NavigationMenuItem>
                                <Link href={`/internal/v1/guilds`} legacyBehavior passHref>
                                    <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                                        Organizaciones
                                    </NavigationMenuLink>
                                </Link>
                            ...
                            <NavigationMenuItem>
                                <Link href={`/internal/v1/events`} legacyBehavior passHref>
                                    <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                                        Eventos
                                    </NavigationMenuLink>
                                </Link>
                            ...
                            <NavigationMenuItem>
                                <Link href={`/internal/v1/settings`} legacyBehavior passHref>
                                    <NavigationMenuLink className={navigationMenuTriggerStyle()}>
                                        Ajustes
                                    </NavigationMenuLink>
                                </Link>
