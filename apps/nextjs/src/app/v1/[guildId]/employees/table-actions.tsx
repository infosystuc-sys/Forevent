...
export default function Actions({ original }: { original: ArrayElement<Awaited<RouterOutputs["web"]["userOnGuild"]["getEmployees"]>> }) {
            ...
            <AlertDialog open={open} onOpenChange={setOpen}>
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <Link href={{ pathname: `employees/${original?.id}/modify`, query: { employeeId: original?.id } }}>
                            <DropdownMenuItem>
                                Modificar
                            </DropdownMenuItem>
                        </Link>
                ...
                <AlertDialogContent className="max-w-xl">
                    <AlertDialogHeader className="space-y-4">
                        ...
                        <AlertDialogDescription className="leading-6">
                            Estas por dar de baja permanentemente a <code className="">{original.user.name}</code> de tu organización.
                            Deseas continuar?
